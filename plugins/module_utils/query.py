...
OPERATORS_MAPPING = dict(
    ...
    on='ONToday',
    not_on='NOTONToday',
    trend_on_or_after='DATEPART',
    trend_on_or_before='DATEPART',
    trend_after='DATEPART',
    trend='DATEPART',
    trend_before='DATEPART',
    trend_on='DATEPART',
    relative_on_or_after='RELATIVEGE',
    relative_on_or_before='RELATIVELE',
    relative_after='RELATIVGT',
    relative_before='RELATIVELT',
    relative_on='RELATIVEEE',
    is_more_than='MORETHAN',
    is_less_than='LESSTHAN',
    greater_than_field='GT_FIELD',
    less_than_field='LT_FIELD',
    greater_than_or_is_field='GT_OR_EQUALS_FIELD',
    less_than_or_is_field='LT_OR_EQUALS_FIELD',
    changes='VALCHANGES',
